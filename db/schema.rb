...
ActiveRecord::Schema.define(version: 20180114132235) do

  create_table "obj_options", force: :cascade do |t|
    t.string "title"
    t.integer "question_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["question_id"], name: "index_obj_options_on_question_id"
  end
  ...
  create_table "papers", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["survey_id"], name: "index_papers_on_survey_id"
  end
  ...
  create_table "sub_options", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["question_id"], name: "index_sub_options_on_question_id"
  end
